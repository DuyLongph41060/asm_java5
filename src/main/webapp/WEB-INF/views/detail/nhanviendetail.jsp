...
<form action="/nhan-vien/update/${listSP.id}" method="post">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="tendangnhap" value="${listSP.tendangnhap}">
    </div>
    <div class="mb-3">
        <label class="form-label">Mat Khau:</label>
        <input type="text" class="form-control" name="matkhau" value="${listSP.matkhau}">
    </div>
    <div class="mb-3 row">
    ...
    <a href="/nhan-vein/hien-thi" class="btn btn-dark">Back</a>
