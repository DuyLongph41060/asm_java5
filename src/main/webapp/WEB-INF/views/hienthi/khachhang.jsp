...
<h1>QL KHACH HANG</h1>
<br>
<form action="/khach-hang/search" method="get" class="d-flex mb-3 container">
    <input type="text" name="ten" class="form-control me-2"
           placeholder="Moi nhap ten" required>
    <button type="submit" class="btn btn-primary">Search</button>
</form>
<div class="container">
    <form:form modelAttribute="sp" method="post" action="/khach-hang/add">
    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${list}" var="sp">
            <tr>
                ...
                <td>
                    <a href="/khach-hang/delete/${sp.id}" class="btn btn-dark">Delete</a>
                    <a href="/khach-hang/detail/${sp.id}" class="btn btn-warning">Detail</a>
                </td>
            </tr>
        </c:forEach>
    </table>
