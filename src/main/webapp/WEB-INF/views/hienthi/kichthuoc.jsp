...
<h1>QL KICH THUOC</h1>
<br>
<form action="/kich-thuoc/search" method="get" class="d-flex mb-3 container">
    <input type="text" name="ten" class="form-control me-2"
           placeholder="Moi nhap ten" required>
    <button type="submit" class="btn btn-primary">Search</button>
</form>
<div class="container">
    <form:form modelAttribute="sp" method="post" action="/kich-thuoc/add">
    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${list}" var="sp">
            <tr>
                ...
                <td>
                    <a href="/kich-thuoc/delete/${sp.id}" class="btn btn-dark">Delete</a>
                    <a href="/kich-thuoc/detail/${sp.id}" class="btn btn-warning">Detail</a>
                </td>
            </tr>
        </c:forEach>
    </table>
